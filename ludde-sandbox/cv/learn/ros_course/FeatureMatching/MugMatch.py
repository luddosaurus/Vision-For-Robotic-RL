...
image_1 = cv2.imread('/home/user/catkin_ws_old/src/opencv_for_robotics_images/Unit_4/Course_images/ROS.png',1)
image_2 = cv2.imread('/home/user/catkin_ws_old/src/opencv_for_robotics_images/Unit_4/Course_images/ROS2.jpg',1)
...
image_1 = cv2.resize(image_1, (int(height1/2), int(width1/2)))
image_2 = cv2.resize(image_2, (int(height2/2), int(width2/2)))
